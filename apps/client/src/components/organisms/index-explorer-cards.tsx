...
const IndexExplorerCards = ({
  ...
  useOutsideClick(ref as React.RefObject<HTMLDivElement>, (event: MouseEvent) => {
    ...
    if (selectedimgIndex !== null) {
      ...
      const isimgPreviewClick = target.closest(".image-preview-container") !== null;

      if (isimgPreviewClick) {
        return;
      }
    }
  ...
  const handleCloseimgPreview = (e: React.MouseEvent) => {
  ...
  return (
    <div className="flex flex-col gap-4 max-w-2xl mx-auto w-full mb-6">
                  ...
                  >
                    ...
                    {active.scenes && active.scenes.length > 0 && (
                      <div className="w-full">
                        ...
                        <div className="mb-4">
                          ...
                          <div className="overflow-x-auto pb-2">
                            <div className="flex space-x-2">
                              {active.scenes.map((_scene: any, idx: number) => (
                                <div
                                  key={`thumb-${idx}`}
                        ...
                        {active.scenes.map((scene: any, idx: number) => (
                          <div
                            key={idx}
                          ...
                          >
                            ...
                            <div className="flex flex-wrap gap-1">
                              {scene.keywords.map((keyword: any, kidx: number) => (
                                <span
                                  key={kidx}
      ...
      {/* img Preview Modal */}
      <AnimatePresence>
        {active && typeof active === "object" && selectedimgIndex !== null && (
          <div
              ...
              <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/80 to-transparent p-4">
                <div className="line-clamp-2">
                  <p className="text-white text-sm">
                    {selectedimgIndex !== null &&
                    active.scenes &&
                    active.scenes[selectedimgIndex]
                      ? `Scene ${selectedimgIndex + 1}: ${
                          active.scenes[selectedimgIndex].description
                        }`
...
// Unused component - commented out to fix diagnostic warnings
// const CloseIcon = () => {
//   return (
//     <motion.svg
//       initial={{ opacity: 0 }}
