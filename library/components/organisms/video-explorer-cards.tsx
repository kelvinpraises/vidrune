...
import IndexNewVideo from "@/components/organisms/index-new-video";
...
interface VideoExplorerCardsProps {
  cards: Card[];
  defaultLayout?: "grid" | "list";
}

const VideoExplorerCards = ({
  cards,
  defaultLayout = "grid",
}: VideoExplorerCardsProps) => {
...
export default VideoExplorerCards;
