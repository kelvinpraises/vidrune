    ...
    <div className={cn("relative p-[4px] group")}>
      ...
      >
        ...
        <button
          ...
          type="submit"
          className="absolute right-2 top-1/2 z-51 -translate-y-1/2 bg-[#33CB82] hover:bg-[#33CB82]/80 disabled:opacity-20 disabled:cursor-not-allowed font-medium px-6 rounded-sm py-4 transition duration-200 flex items-center justify-center"
        >
          start
        </button>
